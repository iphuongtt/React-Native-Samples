...
type ProcessImageScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'ProcessImage'
>;
type ProcessImageScreenRouteProp = RouteProp<
  RootStackParamList,
  'ProcessImage'
>;

type Props = {
  route: ProcessImageScreenRouteProp;
  navigation: ProcessImageScreenNavigationProp;
};

export const ProcessImageScreen = ({route}: Props) => {
